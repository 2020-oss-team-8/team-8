...
> - 결정 트리는 정보이득을 최대화하는 방향으로 학습이 진행됨  
...
>   - 결정 트리가 모여서 랜덤 포레스트를 구성하기 때문에 - 숲(forest)와 나무(tree)의 관계  
> - 랜덤 포레스트를 구성하는 각 결정 트리의 예측값들 중 가장 많이 나온 값을 최종 예측값으로 정함(다수결의 원칙을 따름)  
> ![random_forest_1](/images/Joeunchae9835/random_forest_1.png "출처 : 김응희 교수님 수업자료, 'week_13_데이터사이언스개론', p.29")

> - 랜덤포레스트는 결정 트리의 단점인 오버피팅을 줄일 수 있음  
>   - 오버피팅된 결정 트리가 있더라도 서로 다른 방향으로 오버피팅되었다면 그 결과를 평균냄으로써 오버피팅을 줄일 수 있음  
...
> - 아래와 같은 방식으로 동작됨  
> ![random_forest_1](/images/Joeunchse9835/random_forest_2.png "출처 : 김응희 교수님 수업자료, 'week_13_데이터사이언스개론', p.35")  
